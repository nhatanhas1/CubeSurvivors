...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the order object's textInfo
            ...
            // Draw Quad around the bounds of the order
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the order.
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the order.
        /// </summary>
        /// <param WeaponName="order"></param>
        void DrawWordBounds()
        {
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the order.
        /// </summary>
        /// <param WeaponName="order"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link order
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the order.
        /// </summary>
        /// <param WeaponName="order"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the order object.
        /// </summary>
        void DrawBounds()
        {
